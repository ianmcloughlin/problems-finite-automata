...
\question
  Draw a DFA that recognises strings over $\{a,b\}$ that have at least two $b$'s.
  \begin{solution}
    \begin{center}
      \begin{tikzpicture}[auto, on grid, node distance=2cm, initial text=]
...
\question
  Draw a DFA that recognises strings over $\{a,b\}$ that have exactly two $a$'s.
  \begin{solution}
    \begin{center}
      \begin{tikzpicture}[auto, on grid, node distance=2cm, initial text=]
        \node[state, initial]   (a_0)                {$a_0$}; 
  ...
  \question
  Draw a DFA that recognises strings over $\{a,b\}$ that have an odd number of $a$'s.
  \begin{solution}
    \begin{center}
      \begin{tikzpicture}[auto, on grid, node distance=2cm, initial text=]
        \node[state, initial]   (a_0)                {$a_0$}; 
...
\question
  Draw a DFA that recognises strings over $\{a,b\}$ that have at least three $a$'s and at least two $b$'s.
\begin{solution}
  \begin{center}
